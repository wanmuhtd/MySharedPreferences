package com.dicoding.wanmuhtd.mysharedpreferences
...
import com.dicoding.wanmuhtd.mysharedpreferences.databinding.ActivityFormUserPreferenceBinding
...
class FormUserPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(view: View) {
        if (view.id == R.id.btn_save) {
            ...
            val isLoveIM = binding.rgLoveIm.checkedRadioButtonId == R.id.rb_yes
            ...
            saveUser(name, email, age, phoneNo, isLoveIM)
    ...
    private fun saveUser(name: String, email: String, age: String, phoneNo: String, isLoveIM: Boolean) {
